...
const props = defineProps(['video', 'channel', 'userRating'])
...
<template>
    ...
    <AuthenticatedLayout :main="main" :hideSidebar="true">
        <div class="text-xl m-10" ref="main">
            <!-- video -->
            <video class="w-2/3 m-2 ml-0 aspect-video bg-black" controls width="320" height="240">
                <source :src="video.video_asset">
                Your browser does not support the video tag.
            </video> 

            <!-- video info -->
            <div class="p-1 flex w-2/3 space-x-2">
